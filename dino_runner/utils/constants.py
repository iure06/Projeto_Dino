...
DUPLOSCORE = pygame.image.load(os.path.join(IMG_DIR, 'Other/duploScore.png'))
LUCKBOX = pygame.image.load(os.path.join(IMG_DIR, 'Other/luckBox.png'))

BG = pygame.image.load(os.path.join(IMG_DIR, 'Other/Track.png'))

HEART = pygame.image.load(os.path.join(IMG_DIR, 'Other/SmallHeart.png'))

ICON_OVER = pygame.image.load(os.path.join(IMG_DIR, 'Other/GameOver.png'))
ICON_RESET = pygame.image.load(os.path.join(IMG_DIR, 'Other/Reset.png'))
MUSIC = os.path.join(IMG_DIR, "Other/TrilhaSonora.wav")
